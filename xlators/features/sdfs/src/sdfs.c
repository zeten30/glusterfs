...
sdfs_build_parent_loc (loc_t *parent, loc_t *child)
{
        ...
        parent->path = gf_strdup (uuid_utoa (parent->gfid));
        if (!parent->path) {
                return -1;
        }
        return 0;
                    ...
                    int32_t *op_errno)
{
        ...
        *new_frame = copy_frame (frame);
        ...
        (*new_frame)->root->client = frame->root->client;
                   ...
                   mode_t mode, mode_t umask, dict_t *xdata)
{
        ...
        return 0;
err:
        STACK_UNWIND_STRICT (mkdir, local->main_frame, -1, local->op_errno,
            ...
            mode_t umask, dict_t *xdata)
{
        ...
        if (-1 == sdfs_get_new_frame (frame, loc, &new_frame, &op_errno)) {
                goto err;
        }
                         ...
                         int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        if (op_ret < 0) {
                ...
                locks->locked[lk_index] = _gf_true;
        }
